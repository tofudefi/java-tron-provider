...
exports.eth_getBlockByNumber = exports.eth_getBlockByHash = exports.eth_getBlock_ = exports.eth_getTransactionByHash = void 0;
...
exports.eth_getBlock_ = (byNumber = false) => async ([arg1, fullTransactions], ctx) => {
    ...
    if (byNumber) {
        if (arg1 === "latest") {
            ...
            const num = index_js_1.hexToNumber(arg1);
            body = { num };
    ...
    if (!Object.keys(data).length) {
        throw new errors_js_1.ClientError(`Unknown block ${blockIdStr}`);
    }
    ...
    // console.dir({ data }, { depth: null });
    let ethBlock = index_js_1.block.fromTron(data);
    ...
    ethBlock.transactions = ethBlock.transactions.filter((tx) => tx.value[0] !== "-");
    if (!fullTransactions) {
        ethBlock = {
            ...ethBlock,
...
*/
exports.eth_getBlockByHash = exports.eth_getBlock_(false);
/*
...
*/
exports.eth_getBlockByNumber = exports.eth_getBlock_(true);
