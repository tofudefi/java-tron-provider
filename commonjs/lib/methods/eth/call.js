 ...
 */
exports.eth_call = async ([{ from, to, gas, gasPrice, value, data }, blockNum], ctx) => {
    ...
    if (blockNum !== "latest") {
        index_js_1.warn('eth_getTransactionCount: second argument defaulted to "latest"');
    }
    index_js_1.warn("eth_call not fully implemented");
    // Notes:
