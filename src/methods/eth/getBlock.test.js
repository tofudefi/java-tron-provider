...
const expectedBlock = {
  ...
  parentHash:
    "0x000000000052570c22183fa9f52bf9136d09fc0f1209d4d2094324d0c9a47b71",
  ...
  transactions: [
    {
      ...
      hash:
        "0x689e181215e3e940e57041c6a0204475d930e173e8f7e5d191176f79720fa347",
      value: "0x0",
      gas: "0x0",
    ...
    },
    {
      ...
      to: "0x596f27c0ec9cfd403da2019926f8571450bafebd",
      hash:
        "0xac61d5b7c53f468fa22e71af016e57b5a8db4db2f9959308d140f2468facb5e9",
      value: "0x0",
      gas: "0x0",
      gasPrice: "0x4a817c800",
      input: "0x",
...
test("eth_getBlockByHash (full transactions)", async (t) => {
...
test("eth_getBlockByNumber (full transactions)", async (t) => {
...
test("eth_getBlockByNumber 2 (tx hashes)", async (t) => {
  const res = await eth.eth_getBlockByNumber(
    [
      // TODO: genesis block no block number in block_header??
      numberToHex(5399339),
  ...
  t.deepEqual(res, {
    ...
    number: "0x52632b",
    parentHash:
      "0x000000000052632a3fab4a3a489459810a2af6b6f166c07f44522b5d0f4e9e36",
    receiptsRoot:
      "0x56e81f171bcc55a6ff8345e692c0f86e5b48e01b996cadc001622fb5e363b421",
    sha3Uncles:
      "0x1dcc4de8dec75d7aab85b567b6ccd41ad312451b948a7413f0a142fd40d49347",
...
test("eth_getBlock nile 4440110 does not throw (ShieldedTransferContract)", async (t) => {
  const nileContext = createContext({ network: "nile" });

  const res = await eth.eth_getBlockByNumber(
    [numberToHex(4440110), true],
    nileContext
  );
